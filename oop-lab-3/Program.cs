...
namespace oop_lab_3
{
    class Array 
    {
        ...
        {
            this.production = new Production(ownerId, ownerName, ownerCompany);
        }
        ...
        public class Date
        {
            ...
            public Date()
            {
                this.time = new DateTime(2022, 11, 03, 01, 20, 0);
            }
            ...
            public class Test
            {
                public void test(Date a)
                {
                    a.showDate(); //доступ к элементам родительского класса из дочернего /
